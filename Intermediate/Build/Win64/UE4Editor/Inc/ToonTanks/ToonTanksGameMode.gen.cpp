...
// Cross Module References
	...
	TOONTANKS_API UFunction* Z_Construct_UFunction_AToonTanksGameMode_GameOver();
	TOONTANKS_API UFunction* Z_Construct_UFunction_AToonTanksGameMode_StartGame();
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AToonTanksGameMode, nullptr, "GameOver", sizeof(ToonTanksGameMode_eventGameOver_Parms), Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08080800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AToonTanksGameMode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AToonTanksGameMode_GameOver, "GameOver" }, // 2177776235
		{ &Z_Construct_UFunction_AToonTanksGameMode_StartGame, "StartGame" }, // 702019340
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AToonTanksGameMode_Statics::ClassParams = {
		...
		0,
		0x009002A8u,
		METADATA_PARAMS(Z_Construct_UClass_AToonTanksGameMode_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AToonTanksGameMode_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AToonTanksGameMode, 3311563610);
